...
export default function Nokia3310Simulator() {
	...
	const handleCenterPress = async () => {
		...
		vibrate([
			120, 500, 120, 500, 120, 500, 240, 500, 240, 120, 500, 120, 500, 120, 500,
			240, 500, 240, 120, 500, 120, 500, 120, 500, 240, 500, 240, 120, 500, 120,
			500, 120, 500, 240, 500, 240, 120, 500, 120, 500, 120, 500, 240, 500, 240,
			500, 240, 500, 240, 120, 500, 120, 500, 120, 500, 240, 500, 240, 120, 500,
			120, 500,
		]);
	};
